...
private constructor(override val subheader: ObservableField<H>, override val subheaderVariableLayoutPair: VariableLayoutPair, itemCollection: Collection<I>, override val itemVariableLayoutPair: VariableLayoutPair,val progressBarEnabled: ObservableBoolean, val onTopItemAppeared: Runnable?, val onBottomItemAppeared: Runnable?, override val onItemClick: Consumer<Pair<Int, I>>?, override val onItemLongClick: Consumer<Pair<Int, I>>?) : PartsRecyclerViewAdapter.Parts<H, I> {
    ...
    companion object {
        ...
        //region ファクトリメソッド
        fun <H, I> create(subheader: ObservableField<H>, subheaderVariableId: Int, @LayoutRes subheaderLayoutId: Int, itemCollection: Collection<I>, itemVariableId: Int, @LayoutRes itemLayoutId: Int, progressBarEnabled: ObservableBoolean, onTopItemAppeared: Runnable?, onBottomItemAppeared: Runnable?, onItemClick: Consumer<Pair<Int, I>>?, onItemLongClick: Consumer<Pair<Int, I>>?): ScrollParts<H, I> {
            return ScrollParts(subheader, VariableLayoutPair(subheaderVariableId, subheaderLayoutId), itemCollection, VariableLayoutPair(itemVariableId, itemLayoutId), progressBarEnabled, onTopItemAppeared, onBottomItemAppeared, onItemClick, onItemLongClick)
        }

        fun <H, I> create(subheader: ObservableField<H>, subheaderVariableId: Int, @LayoutRes subheaderLayoutId: Int, itemCollection: Collection<I>, itemVariableId: Int, @LayoutRes itemLayoutId: Int, progressBarEnabled: ObservableBoolean, onBottomItemAppeared: Runnable?, onItemClick: Consumer<Pair<Int, I>>?): ScrollParts<H, I> {
            return create(subheader, subheaderVariableId, subheaderLayoutId, itemCollection, itemVariableId, itemLayoutId, progressBarEnabled, null, onBottomItemAppeared, onItemClick, null)
        }

//        fun <H, I> create(subheader: ObservableField<H>, subheaderVariableId: Int, @LayoutRes subheaderLayoutId: Int, itemCollection: Collection<I>, itemVariableId: Int, @LayoutRes itemLayoutId: Int): ScrollParts<H, I> {
//            return create(subheader, subheaderVariableId, subheaderLayoutId, itemCollection, itemVariableId, itemLayoutId, null, null)
//        }
//
//        fun <H, I> create(subheader: H, subheaderVariableId: Int, @LayoutRes subheaderLayoutId: Int, itemCollection: Collection<I>, itemVariableId: Int, @LayoutRes itemLayoutId: Int, onItemClick: Consumer<Pair<Int, I>>?, onItemLongClick: Consumer<Pair<Int, I>>?): ScrollParts<H, I> {
...
//        }
//
//        fun <H, I> create(subheader: H, subheaderVariableId: Int, @LayoutRes subheaderLayoutId: Int, itemCollection: Collection<I>, itemVariableId: Int, @LayoutRes itemLayoutId: Int, onItemClick: Consumer<Pair<Int, I>>?): ScrollParts<H, I> {
...
//        }
//
//        fun <H, I> create(subheader: H, subheaderVariableId: Int, @LayoutRes subheaderLayoutId: Int, itemCollection: Collection<I>, itemVariableId: Int, @LayoutRes itemLayoutId: Int): ScrollParts<H, I> {
