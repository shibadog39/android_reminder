...
/**
 * PartsRecyclerViewAdapter に表示する並べ替え可能なセクション。
 */
class SortableParts<H, I>
private constructor(override val subheader: ObservableField<H>, override val subheaderVariableLayoutPair: VariableLayoutPair, itemCollection: Collection<I>, override val itemVariableLayoutPair: VariableLayoutPair, @param:IdRes val sortingHandlerViewId: Int, override val onItemClick: Consumer<Pair<Int, I>>?, override val onItemLongClick: Consumer<Pair<Int, I>>?) : PartsRecyclerViewAdapter.Parts<H, I> {
    ...
    private var adapter: PartsRecyclerViewAdapter<H, I>? = null
    ...
    init {
        ...
        itemSortingHelper = ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(ItemTouchHelper.UP or ItemTouchHelper.DOWN, 0) {
            ...
            override fun clearView(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder) {
                ...
                this@SortableParts.subheader.removeOnPropertyChangedCallback(onSubheaderChangedCallback!!)
                ...
                this@SortableParts.subheader.addOnPropertyChangedCallback(onSubheaderChangedCallback!!)
            }
    ...
    companion object {
        ...
        //region ファクトリメソッド
        fun <H, I> create(subheader: ObservableField<H>, subheaderVariableId: Int, @LayoutRes subheaderLayoutId: Int, itemCollection: Collection<I>, itemVariableId: Int, @LayoutRes itemLayoutId: Int, @IdRes sortingHandlerViewId: Int, onItemClick: Consumer<Pair<Int, I>>?, onItemLongClick: Consumer<Pair<Int, I>>?): SortableParts<H, I> {
            return SortableParts(subheader, VariableLayoutPair(subheaderVariableId, subheaderLayoutId), itemCollection, VariableLayoutPair(itemVariableId, itemLayoutId), sortingHandlerViewId, onItemClick, onItemLongClick)
        }

        fun <H, I> create(subheader: ObservableField<H>, subheaderVariableId: Int, @LayoutRes subheaderLayoutId: Int, itemCollection: Collection<I>, itemVariableId: Int, @LayoutRes itemLayoutId: Int, @IdRes sortingHandlerViewId: Int, onItemClick: Consumer<Pair<Int, I>>?): SortableParts<H, I> {
        ...
        fun <H, I> create(subheader: ObservableField<H>, subheaderVariableId: Int, @LayoutRes subheaderLayoutId: Int, itemCollection: Collection<I>, itemVariableId: Int, @LayoutRes itemLayoutId: Int, @IdRes sortingHandlerViewId: Int): SortableParts<H, I> {
        ...
        fun <H, I> create(subheader: H, subheaderVariableId: Int, @LayoutRes subheaderLayoutId: Int, itemCollection: Collection<I>, itemVariableId: Int, @LayoutRes itemLayoutId: Int, @IdRes sortingHandlerViewId: Int, onItemClick: Consumer<Pair<Int, I>>?, onItemLongClick: Consumer<Pair<Int, I>>?): SortableParts<H, I> {
        ...
        fun <H, I> create(subheader: H, subheaderVariableId: Int, @LayoutRes subheaderLayoutId: Int, itemCollection: Collection<I>, itemVariableId: Int, @LayoutRes itemLayoutId: Int, @IdRes sortingHandlerViewId: Int, onItemClick: Consumer<Pair<Int, I>>?): SortableParts<H, I> {
        ...
        fun <H, I> create(subheader: H, subheaderVariableId: Int, @LayoutRes subheaderLayoutId: Int, itemCollection: Collection<I>, itemVariableId: Int, @LayoutRes itemLayoutId: Int, @IdRes sortingHandlerViewId: Int): SortableParts<H, I> {
